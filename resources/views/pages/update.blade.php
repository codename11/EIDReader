...
@section("content")
    ...
    @if($response && $response->member)
        ...
        <div class="card myCard1 cent">
            ...
            <div class="card-header alert alert-info">{{$response->message}}</div>
        ...
        <div class="grid-container1 cent">
            <form method="POST" action={{"/update/".($response && $response->member && $response->member->id ? $response->member->id : $memberId)}} class="">
